...
import profileImage from 'figma:asset/4edc6534445f524cffe7417621d0109eb59da713.png';
...
export function Hero() {
  ...
  return (
    <section id="hero" className="snap-section flex items-center justify-center bg-[#0D0D0D] px-6">
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Side - Content */}
          <div className="space-y-6">
            <div className="space-y-2">
              <p className="text-[#A259FF] tracking-wider uppercase">Portfolio</p>
              <p className="text-2xl text-[#F1F1F1]/80">Hello I am,</p>
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <div className="flex items-center gap-2 px-4 py-3 bg-[#1A1A1A] border border-[#F1F1F1]/10 rounded-full">
                ...
                <span className="text-[#F1F1F1]">Alor Setar, Malaysia</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-3 bg-[#1A1A1A] border border-[#F1F1F1]/10 rounded-full">
                <Award className="w-5 h-5 text-[#A259FF]" />
                <span className="text-[#F1F1F1]">3× Dean's List</span>
              </div>
            </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="absolute -top-4 -left-4 w-28 h-28 bg-[#FFD600] opacity-20 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }}></div>
            </div>
          </div>
        </div>
      </div>
